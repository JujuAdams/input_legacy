...
var _new_bindings_array = [];

var _i = 0;
repeat(array_length_1d(_bindings_array))
{
    var _binding_array = _bindings_array[_i];
    if (is_array(_binding_array)) _new_bindings_array[@ array_length_1d(_new_bindings_array)] = _binding_array;
    
    ++_i;
}

_action_array[@ INPUT_ACTION.BINDINGS] = _new_bindings_array;