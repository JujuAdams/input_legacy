...
input_handle_keyboard(       0, E_INPUT_SLOT.RIGHT,   vk_right, ord("D")              );

input_handle_gamepad_button( 0, E_INPUT_SLOT.JUMP ,   gamepad_device, gp_face1, gp_face2, gp_face3, gp_face4 );
input_handle_keyboard(       0, E_INPUT_SLOT.JUMP ,   vk_space, vk_enter              );
input_handle_mouse(          0, E_INPUT_SLOT.JUMP ,   mb_left                         );
