...
#macro INPUT_NO_SEPARATE_KEYBOARD_AND_MOUSE  true   //Whether to prevent separate keyboard and mouse operation, forcing INPUT_SOURCE.KEYBOARD_AND_MOUSE when not using a gamepad
